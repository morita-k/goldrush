...
module PhotosHelper
  ...
  def get_photo_thumbnail(photo)
    ...
    str += "<br/>".html_safe
    str += button_to '左回転', url_for_rotate_photo(photo.id, true, 'photo')
    str += "　　　"
    str += button_to '右回転', url_for_rotate_photo(photo.id, false, 'photo')
    str += "<br/>".html_safe
  ...
  def get_photo_thumbnail_link(photo, bp_pic_id)
    str = "<center>".html_safe
    ...
    str += "<br/>".html_safe
    str += button_to '左回転', url_for_rotate_photo(photo.id, true, 'bp_pic' , bp_pic_id)
    str += "　　　"
    str += button_to '解除', {:controller => :bp_pic, :action => :update_photo_unlink, :photo_id => photo.id}
    str += "　　　"
    str += button_to '右回転', url_for_rotate_photo(photo.id, false, 'bp_pic', bp_pic_id)
    str += "</center>".html_safe
  end
end
